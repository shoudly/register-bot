...
client.on("guildMemberAdd", async member => {
 ...
 require("moment-duration-format");
  let channel = member.guild.channels.cache.get("868159702175981591");
  channel.send(`${member} <@&868159702142439427>`);
  moment.locale("tr");
  let embed = new Discord.MessageEmbed()
    ...
    .setDescription(`Merhaba Hoşgeldin Dostum,

 Seninle beraber \`${
    member.guild.memberCount
  }\` kişi olduk!

Yetkiliyi Sese Geçip Bekleyebilirsin.**

 Hesabın kuruluş zamanı **${moment(
    user.createdAt
...
client.on("ready", () => {
  client.channels.cache.get("868159703778201682").join();
})
...
client.on("userUpdate", async (oldUser, newUser) => {
  ...
  const tag = '𐋃'
  const sunucu = '868159702062735423'
  const log = '868159703136469013'
  const rol = '868159702129840213'
